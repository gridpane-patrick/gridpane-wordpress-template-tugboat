                ...
                [
                    ...
                    '_wc_appointment_availability_rules'      => [
                        ...
                        'options'     => [
                            ...
                            'qty'         => [
                                'label'       => __('Capacity', 'wc-frontend-manager-ultimate'),
                                'type'        => 'number',
                                'class'       => 'wcfm-text wcfm_ele avail_rules_ele avail_rule_capacity appointment',
                                'label_class' => 'wcfm_title avail_rules_ele avail_rules_label appointment',
                                'hints'       => __('The maximum number of appointments per slot. Overrides general product capacity.', 'wc-frontend-manager-ultimate'),
                            ],
                            'avail_id'    => [
                                'type'  => 'hidden',
                                'class' => 'avail_id',
                            ...
                            'appointable' => [
                                'label'       => __('Appointable', 'wc-frontend-manager-ultimate'),
                                'type'        => 'select',
                                'options'     => [
                ...
                apply_filters(
                    ...
                    [
                        ...
                        '_wc_appointment_staff_assignment' => [
                            'label'       => __('Staff selection', 'wc-frontend-manager-ultimate'),
                            'type'        => 'select',
                            'options'     => [
                        ...
                        '_wc_appointment_staffs'           => [
                            'label'       => __('Staffs', 'wc-frontend-manager-ultimate'),
                            'type'        => 'multiinput',
