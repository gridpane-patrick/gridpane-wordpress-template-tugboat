        ...
        switch ( $end_point ) {
            ...
            case 'wcfm-fncy-product-designer':
                ...
                wp_enqueue_script(
                    ...
                    $WCFMu->library->js_lib_url . 'wc_fncy_product_designer/wcfmu-script-manage-fancy-products-designer.js',
                    array(
                        'jquery-ui-core',
                        'jquery-ui-mouse',
                        'jquery-ui-sortable',
            ...
            case 'wcfm-fncy-product-builder':
                ...
                wp_register_script(
                    'wcfm-fpd-product-builder',
                    $WCFMu->library->js_lib_url . 'wc_fncy_product_designer/wcfmu-script-manage-fancy-products-builder.js',
                    array(
                        'jquery-ui-core',
                        'jquery-ui-mouse',
                        'jquery-ui-sortable',
                    ...
                    $script_options = FPD_Resource_Options::get_options(
                        array(
