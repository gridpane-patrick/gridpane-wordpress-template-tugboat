...
class Google_MP_GA4 extends Google_MP {
	...
	public function __construct( $options ) {
		...
		$this->post_request_args['blocking'] = apply_filters_deprecated('wooptpm_send_http_api_ga_4_requests_blocking', [$this->post_request_args['blocking']], '1.13.0', 'wpm_send_http_api_ga_4_requests_blocking');
		$this->post_request_args['blocking'] = apply_filters('wpm_send_http_api_ga_4_requests_blocking', $this->post_request_args['blocking']);
	}
