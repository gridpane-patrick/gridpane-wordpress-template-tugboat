...
var edit_Edit = function Edit(_ref) {
  ...
  var blockProps = Object(external_wp_blockEditor_["useBlockProps"])(); // Make sure that the Block will be applicable to render.
...
var checkout_order_summary_gift_card_totals_edit_Edit = function Edit(_ref) {
  var attributes = _ref.attributes;
  var className = attributes.className;
  var blockProps = Object(external_wp_blockEditor_["useBlockProps"])(); // TODO: Use preview data.
