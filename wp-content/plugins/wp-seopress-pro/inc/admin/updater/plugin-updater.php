...
class SEOPRESS_Updater {
    ...
    public function show_update_notification($file, $plugin) {
        ...
        if ('valid' != get_option('seopress_pro_license_status')) {
			printf( esc_html__( '%sRegister%s your copy of SEOPress PRO to receive access to automatic upgrades and support. Need a license key? %sPurchase one now%s.', 'wp-seopress-pro' ), '<a href="' . admin_url() . 'admin.php?page=seopress-license">', '</a>', '<a href="https://www.seopress.org/pricing">', '</a>' );
