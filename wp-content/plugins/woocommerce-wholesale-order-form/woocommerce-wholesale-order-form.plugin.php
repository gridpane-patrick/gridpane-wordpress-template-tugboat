...
require_once ( WWOF_INCLUDES_ROOT_DIR . '/v2/class-wwof-api-request.php' );
...
class WooCommerce_WholeSale_Order_Form {
    ...
    */
    ...
    public function run() {
        ...
        // WC API Custom Endpoints
        add_action( 'woocommerce_loaded' , function() {

            add_action( 'rest_api_init', function() {
                require_once ( WWOF_INCLUDES_ROOT_DIR . 'v2/class-wwof-api-products-controller.php' );
            } , 5 );
