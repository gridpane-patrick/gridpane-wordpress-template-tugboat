...
class WC_Gateway_Kashier extends WC_Payment_Gateway_CC
{
    ...
    /**
     * @var \ITeam\Kashier\ApiContext\ApiContext
     */
    public $apiContext;
    ...
    public function check_response()
    {
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            $this->apiContext = new \ITeam\Kashier\Rest\ApiContext(
                ...
                new \ITeam\Kashier\Auth\KashierKey($payment_gateway->api_key),
                $payment_gateway->secret_key
            );

            $queryString = http_build_query($data, $numeric_prefix = "", $arg_separator = '&', $encoding_type = PHP_QUERY_RFC3986);
        
            $validateSignature = new \ITeam\Kashier\Security\ValidateSignature($this->apiContext, $queryString);
    ...
    public function process_refund($order_id, $amount = null, $reason = '')
    {
        ...
        try {
            ...
            $refundRequest = new \ITeam\Kashier\Api\Data\RefundRequest();
            ...
            $refund = new \ITeam\Kashier\Api\Refund();
