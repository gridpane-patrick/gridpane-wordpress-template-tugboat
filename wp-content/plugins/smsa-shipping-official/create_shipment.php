...
else
{
    ...
    <h3>CONSIGNEE DETIALS FOR ORDER <?php echo $order_id;?></h3>
  <input type="hidden" name="<?php echo $i;?>[action]" value="create_shipment">
    ...
    <input type="hidden" name="<?php echo $i;?>[declaredValue]" value="<?php echo $dv; ?>">
    <input type="hidden" name="<?php echo $i;?>[cod]" value="<?php echo $amount; ?>">
   
    <input type="hidden" name="<?php echo $i;?>[shipmentCurrency]" value="<?php echo $order_data['currency']; ?>">
    <input type="hidden" name="<?php echo $i;?>[shipmentContents]" value="<?php echo $final_note; ?>">
    <div class="row">
      <div class="col">
        <label>Name</label>
