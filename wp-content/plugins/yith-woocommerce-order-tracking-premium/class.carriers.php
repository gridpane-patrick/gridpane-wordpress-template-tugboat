...
//				),
				...
				'FEDEX_MEXICO' => array(
					'name' => 'FEDEX Mexico',
					'track_url' => 'https://www.fedex.com/apps/fedextrack/?action=track&trackingnumber=[TRACK_CODE]&cntry_code=mx&locale=es_MX'
				),
...
//					'track_url' => 'http://www.correos.es/ss/Satellite/site/pagina-localizador_referencia_expedicion/sidioma=en_GB&Referencia=[TRACK_CODE]',
                ...
                'PELICAN_TAIWAN' => array(
                    'name'      => '宅配通',
                    'track_url' => 'http://query2.e-can.com.tw/self_link/id_link_c.asp?txtMainid=[TRACK_CODE]',
                ),
				...
				'4AEXPRESS' => array(
					'name' => '4A Express',
					'track_url' => 'http://cms.4aexpress.com/Query/TrackAwbNoQuery.aspx?awbno=[TRACK_CODE]',
				),
				'DOMINA' => array(
					'name' => 'Domina',
					'track_url' => 'https://www.domina.com.co/',
				),
				'99MINUTOS' => array(
					'name' => '99minutos.com',
					'track_url' => 'https://www.99minutos.com/search',
				),
				'COMET' => array(
					'name' => 'Comet',
					'track_url' => 'https://ilogix.capitaltransport.com.au/'
				),
				'COURIER CENTER' => array(
					'name' => 'Courier Center',
					'track_url' => 'https://www.courier.gr/track/result?tracknr=[TRACK_CODE]',
				),
				'CTI_LOGISTICS' => array(
					'name' => 'CTI Logistics',
					'track_url' => 'https://www.ctilogistics.com/',
				),
				'ADSONE' => array(
					'name' => 'ADSOne',
					'track_url' => 'https://tracking.icumulus.cloud/[TRACK_CODE]',
				),
				'4-72' => array(
					'name' => '4-72',
					'track_url' => 'http://svc1.sipost.co/trazawebsip2/default.aspx?Buscar=[TRACK_CODE]',
 				),
				'KRONOS EXPRESS' => array(
					'name' => 'Kronos Express',
					'track_url' => 'https://www.kronosexpress.com/tracking-system-gr/',
				),
				'COURIER_POST' => array(
					'name' => 'Courier Post (New Zealand)',
					'track_url' => 'https://www.nzpost.co.nz/tools/tracking?trackid=[TRACK_CODE]',
				),
				'EMISSARY' => array(
					'name' => 'Emissary',
					'track_url' => 'https://emissary.mx/tracking.html?tracking=[TRACK_CODE]',
				),
				'DPD_ESTONIA' => array(
					'name' => 'DPD Estonia',
					'track_url' => 'https://tracking.dpd.de/status/et_EE/parcel/[TRACK_CODE]',
				),
				'OMNIVA' => array(
					'name' => 'Omniva',
					'track_url' => 'https://www.omniva.ee/private/track_and_trace',
				),
				'ITELLA' => array(
					'name' => 'Smartpost/Itella',
					'track_url' => 'https://itella.ee/en/private-customer/parcel-tracking/?trackingCode=[TRACK_CODE]',
				),
				'ARCBEST' => array(
					'name' => 'ArcBest',
					'track_url' => 'https://arcb.com/tools/tracking.html#/[TRACK_CODE]'
				),
				'ZÁSIELKOVŇA' => array(
					'name' => 'Zásielkovňa',
					'track_url' => 'https://tracking.packeta.com/sk/?id=[TRACK_CODE]'
				),
				'VALUE LOGISTICS' => array(
					'name' => 'Value Logistics',
					'track_url' => 'https://expressportal.value.co.za/FWO_Express/views/public_track_trace.html'
				),
				'SAIA' => array(
					'name' => 'SAIA',
					'track_url' => 'https://www.saia.com/track/details;pro=[TRACK_CODE]',
				),
				'DHL_PARCEL_ES'     => array(
					'name'      => 'DHL Parcel ES',
					'track_url' => 'https://clientesparcel.dhl.es/LiveTracking',
				),
				'MAINFREIGHT'     => array(
					'name'      => 'Mainfreight',
					'track_url' => 'https://www.mainfreight.com/en-nz/tracking?trackingnumber=[TRACK_CODE]',
				),
				'DPD_PORTUGAL'     => array(
					'name'      => 'DPD Portugal',
					'track_url' => 'https://dpd.pt/track-and-trace?reference=[TRACK_CODE]',
				),
				'TOLL_IPEC'     => array(
					'name'      => 'Toll Ipec',
					'track_url' => 'https://www.mytoll.com/',
				),
				'TRAMACO_EXPRESS'     => array(
					'name'      => 'TRAMACO EXPRESS',
					'track_url' => 'http://www.tramaco.com.ec/index.php/track',
				),
				'SNOWL'     => array(
					'name'      => 'SNOWL shipping',
					'track_url' => 'www.snowl.co.uk',
				),
				'REDUR'     => array(
					'name'      => 'REDUR',
					'track_url' => 'http://redlink.redur.es/RedLink/jsp/jsp_esp/listadoExpedicionesB.jsp',
				),
				'VINOS_COURIERS'     => array(
					'name'      => 'Vinos Courier',
					'track_url' => 'https://vinoscouriers.com.au/',
				),
				'SWYFT_LOGISTICS'     => array(
					'name'      => 'Swyft Logistics',
					'track_url' => 'http://parceltracking.swyftlogistics.com/?[TRACK_CODE]',
				),
				'BOHAUL_EXPRESS' => array(
					'name'      => 'Bohaul Express',
					'track_url' => 'https://online.jaix.net.au/Bohaul/Account/Login.aspx',
				)
			);
