...
if ( ! class_exists( 'YITH_WooCommerce_Order_Tracking_Premium' ) ) {
    ...
    class YITH_WooCommerce_Order_Tracking_Premium extends YITH_WooCommerce_Order_Tracking {
        ...
        function show_tracking_information( $order, $pattern, $prefix = '', $output = 'frontend' ) {
            ...
            return $prefix . apply_filters( 'yith_ywot_order_tracking_final_message', $message, $order, $data );
        }
        ...
        public function show_picked_up_icon( $order, $css_class = '' ) {
            ...
            echo '<a class="' . $track_css_class . '" href="' . $track_url . '" target="_blank" data-title="' . apply_filters( 'yith_ywot_order_tracking_final_message_orders_page', $message, $order ) . '">';
            echo '<span class="ywot-icon-delivery track-icon track-button" data-title="' . apply_filters( 'yith_ywot_order_tracking_final_message_orders_page', $message, $order ) .'"></span>';
        ...
        function add_email_shipping_details( $order, $sent_to_admin, $plain_text, $email ) {
            ...
            $refund_emails = apply_filters( 'yith_ywot_tracking_details_on_order_status', array(
