...
= 1.6.15 - Released on 10 May 2021 =

* New: Support for WooCommerce 5.3
* New: carrier Flecha Amarilla
* New: carrier Seabourne Express
* New: carrier Chronofresh
* New: carrier MTM Transports
* New: carrier Coldline
* Tweak: added email field to 'yith_check_tracking_info_form' shortcode
* Tweak: improved enqueue scripts method
* Update: YITH plugin framework
* Update: translation files
* Update: updated XPRESSBEES carrier

= 1.6.14 - Released on 07 April 2021 =

* New: Support for WooCommerce 5.2
* New: added new carrier Internet Express
* New: added new carrier Geodis Calberson
* New: added new carrier Regional Road
* Update: YITH plugin framework

= 1.6.13 - Released on 10 March 2021 =

* New: Support for WooCommerce 5.1
* New: Support for WordPress 5.7
* New: added new carrier TRAMACO EXPRESS
* New: added new carrier SNOWL shipping
* New: added new carrier REDUR
* New: added new carrier Vinos Courier
* New: added new carrier Swyft Logistics
* New: added new carrier Bohaul Express
* Update: YITH Plugin Framework

= 1.6.12 - Released on 10 February 2021 =

* New: Support for WooCommerce 5.0
* New: added new carrier DPD Portugal
* New: added new carrier Toll Ipec
* Update: YITH plugin framework

= 1.6.11 - Released on 12 January 2021 =

* New: Support for WooCommerce 4.9
* New: added new carrier ADSOne
* New: added new carrier 4-72
* New: added new carrier Kronos Express
* New: added new carrier Courier Post (New Zealand)
* New: added new carrier Emissary
* New: added new carriers, DPD Estonia, Omniva and Smartpost/Itella
* New: added new carrier ArcBest
* New: added carrier Zásielkovňa
* New: added carrier Value Logistics
* New: added carrier SAIA
* New: added new carrier DHL Parcel ES
* New: added carrier Mainfreight
* New: added new carrier Packlink Pro Italy
* Update: plugin framework
* Update: updated 4-72 carrier URL
* Update: update PELICAN TAIWAN tracking link
* Update: updated BRT Courier Express tracking link
* Fix: prevent getting id of non-object
* Dev: added new filter yith_ywot_tracking_details_on_order_status
* Dev: added wc-enhanced-select class to select options

= 1.6.10 - Released on 27 November 2020 =

* New: Support for WooCommerce 4.8
* New: added new carrier 4A Express
* New: added new carrier Domina
* New: added new carrier 99minutos.com
* New: added new carrier Comet
* New: added new carrier Courier Center
* New: added new carrier CTI Logistics
* New: added new carrier FEDEX Mexico
* Update: plugin framework
* Update: updated COLISSIMO tracking link
* Update: updated Chronopost carrier name
* Dev: include new params to the yith_ywot_order_tracking_final_message filter
* Dev: moved the yith_ywot_order_tracking_final_message filter
* Dev: removed the .ready method from jQuery
* Dev: added new filter yith_ywot_order_tracking_final_message_orders_page
