...
class Eprolo_OptionsManager {
	...
	public function curlPost( $url ) {
		//      $ch = curl_init();
		//      $params[ CURLOPT_URL ] = 'https://eprolo.com/app/' . $url;    //Request URL
		...
		$response = wp_remote_get( 'https://eprolo.com/app/' . $url, $argc );
	...
	public function settingsPage() {
		...
		?>
			...
			<ul class="nav nav-pills mb-3" id="Go_to_EPROLODIV" role="tablist" style="padding-top:10px;display: none;">
				...
				<li class="nav-item">
					  <a class="nav-link active" id="go_to_url" href="https://eprolo.com/app/WAuthToken.html?token=<?php echo esc_attr( $eprolo_store_token ); ?>&domain=<?php echo esc_attr( $eprolo_shop_url ); ?>  " target="_blank" aria-selected="true">Go to EPROLO</a>
				</li>
			</ul>
