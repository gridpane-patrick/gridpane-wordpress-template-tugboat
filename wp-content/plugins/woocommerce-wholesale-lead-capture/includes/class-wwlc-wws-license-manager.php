        ...
        */
        ...
        public function wwcLicenseSettingsHeader() {
            ...
            if ( is_multisite() ) {
                ...
                $wwlc_license_settings_url = $current_url . "wp-admin/network/admin.php?page=wws-ms-license-settings&tab=wwlc";
        ...
        public function wwcLicenseSettingsPage() {
            ...
            require_once( WWLC_PLUGIN_DIR . 'views/wws-license-settings/view-wwlc-wss-settings-page.php' );
