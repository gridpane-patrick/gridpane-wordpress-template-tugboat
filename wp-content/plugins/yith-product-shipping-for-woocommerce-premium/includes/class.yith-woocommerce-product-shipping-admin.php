...
if ( ! class_exists( 'YITH_WooCommerce_Product_Shipping_Admin' ) ) {
	...
	class YITH_WooCommerce_Product_Shipping_Admin {
		 ...
		 */
		protected $_panel_page = 'wc-settings&tab=shipping&section=yith_wc_product_shipping_method';
		...
		public function __construct() {
			 ...
			 */
			add_filter( 'plugin_action_links_' . plugin_basename( YITH_WCPS_DIR . '/' . basename( YITH_WCPS_FILE ) ), array( $this, 'action_links' ) );
		...
		public function action_links( $links ) {
			$links = yith_add_action_links( $links, $this->_panel_page, false, YITH_WCPS_SLUG );
			return $links;
		}
		 ...
		 *	Add the action links to plugin admin page
		 */
		public function plugin_row_meta( $new_row_meta_args, $plugin_meta, $plugin_file, $plugin_data, $status, $init_file = 'YITH_WCPS_INIT' ) {
			if ( defined( $init_file ) && constant( $init_file ) == $plugin_file ) {
				$new_row_meta_args['slug'] = YITH_WCPS_SLUG;
