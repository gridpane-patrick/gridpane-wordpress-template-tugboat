		...
		public function print_balance_totals( $context = '' ) {
			...
			<tr class="balance-shipping-total">
				<th <?php echo 'email' == $context ? 'class="td" colspan="2"' : ''; ?>>
					...
					echo esc_html( sprintf( __( '%s subtotal', 'yith-woocommerce-deposits' ), apply_filters( 'yith_wcdp_balance_filter', __( 'Balance', 'yith-woocommerce-deposits-and-down-payments' ) ) ) );
					?>
				</th>
