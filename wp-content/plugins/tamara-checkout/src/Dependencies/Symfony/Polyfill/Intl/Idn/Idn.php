...
namespace Tamara\Wp\Plugin\Dependencies\Symfony\Polyfill\Intl\Idn;

use Exception;
use TWPPCO_Normalizer;
use Tamara\Wp\Plugin\Dependencies\Symfony\Polyfill\Intl\Idn\Resources\unidata\DisallowedRanges;
use Tamara\Wp\Plugin\Dependencies\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex;
...
final class Idn
{
    ...
    private static function process($domain, array $options, Info $info)
    {
        ...
        if (!TWPPCO_Normalizer::isNormalized($domain, TWPPCO_Normalizer::FORM_C)) {
            $domain = TWPPCO_Normalizer::normalize($domain, TWPPCO_Normalizer::FORM_C);
        }
    ...
    private static function validateLabel($label, Info $info, array $options, $canBeEmpty)
    {
        ...
        if (!TWPPCO_Normalizer::isNormalized($label, TWPPCO_Normalizer::FORM_C)) {
