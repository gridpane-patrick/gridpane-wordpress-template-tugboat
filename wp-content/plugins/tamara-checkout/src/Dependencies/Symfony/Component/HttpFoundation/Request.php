...
namespace Tamara\Wp\Plugin\Dependencies\Symfony\Component\HttpFoundation;

use Tamara\Wp\Plugin\Dependencies\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use Tamara\Wp\Plugin\Dependencies\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use Tamara\Wp\Plugin\Dependencies\Symfony\Component\HttpFoundation\Session\SessionInterface;
    ...
    private static function createRequestFromFactory(array $query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null): self
    {
        if (self::$requestFactory) {
            ...
            if (!$request instanceof self) {
                throw new \LogicException('The Request factory must return an instance of Tamara\Wp\Plugin\Dependencies\Symfony\Component\HttpFoundation\Request.');
            }
