    ...
    class YITH_WCGPF_Merchant_Google_Premium extends YITH_WCGPF_Merchant_Google{
        ...
        function google_attributes() {
            ...
            $attributes =  array(
				...
				array(
					'id_group' => esc_html__('Others','yith-google-product-feed-for-woocommerce'),
					'content' => array(
						"store_code"       				=> esc_html__('Store code','yith-google-product-feed-for-woocommerce'),
						"quantity"						=> esc_html__('Quantity','yith-google-product-feed-for-woocommerce'),
						"pickup_method"                	=> esc_html__('Pickup method','yith-google-product-feed-for-woocommerce'),
						"pickup_sla"               		=> esc_html__('Pickup sla','yith-google-product-feed-for-woocommerce'),
					),
				),
            );
        ...
        public function add_google_custom_product_properties($attributes) {
            $product_feed_information = array(
                ...
                'content'   => array(
					...
					"yith_wcgpf_pfd_store_code"            		=> __('Store code','yith-google-product-feed-for-woocommerce'),
					"yith_wcgpf_pfd_pickup_method"              => __('Pickup method','yith-google-product-feed-for-woocommerce'),
					"yith_wcgpf_pfd_pickup_sla"                 => __('Pickup sla','yith-google-product-feed-for-woocommerce'),
					"yith_wcgpf_pfd_unit_pricing_measure"       => __('Unit pricing measure','yith-google-product-feed-for-woocommerce'),
					"yith_wcgpf_pfd_unit_pricing_base_measure"  => __('Unit pricing base measure','yith-google-product-feed-for-woocommerce'),
