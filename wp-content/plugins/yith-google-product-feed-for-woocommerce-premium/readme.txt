...
= 1.1.20 - Released: 08 March 2021 =

* New: support for WordPress 5.7
* New: Support for WooCommerce 5.1
* Update: YITH plugin framework

= 1.1.19 - Released on 09 February 2021 =

* New: Support for WooCommerce 5.0
* New: added option to include/exclude categories when creating a feed
* Update: YITH plugin framework
* Fix: fixed image_link parameter when adding additional images
* Fix: fixed saving value shipping country on variations
* Fix: fixed get product images of variations, now get them from variable product
* Dev: added some filters to allow get product images from external plugins

= 1.1.18 - Released on 13 January 2021 =

* New: Support to WooCommerce 4.9
* Update: Plugin-fw
* Fix: Fixed additional images link option
* Dev: yith_wcgpf_header_encoding

= 1.1.17 - Released on 02 December 2020 =

* New: Support to WooCommerce 4.8
* New: Support for WordPress 5.6
* Update: Plugin-fw
* Fix: Get only publish product
...
= 1.1.15 - Released on 03 October 2020 =

* New: Support to WooCommerce 4.6
* Update: Plugin-fw

= 1.1.14 - Released on 14 September 2020 =

* New: Support to WooCommerce 4.5
* New: Support for WordPress 5.5
* New add store code pickup_method and pickup_sla
* Update: Plugin-fw
* Fix Problem shipping field on feed file
* dev filter yith_wcgpf_before_print_content_value

= 1.1.13 - Released on 07 July 2020 =
