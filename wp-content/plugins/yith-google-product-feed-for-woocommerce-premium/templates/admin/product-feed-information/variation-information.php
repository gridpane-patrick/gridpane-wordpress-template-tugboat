...
<div class="form-row form-row-full">
    ...
    <div>
        ...
        <?php if( apply_filters('yith_wcgpf_show_product_information_on_product_page',true) ) { ?>
			...
			<div class="yith-wcgpf-product-feed-information">
				<label for="yith-wcgpf-custom-label-4"><?php esc_html_e('Store code:', 'yith-google-product-feed-for-woocommerce');?></label>
				<?php echo yith_wcgpf_get_input(array(
					'id' => 'yith-wcgpf-store-code-product',
					'type' => 'text',
					'name' => 'yith-wcgpf-product-feed-configuration['.$variation->ID.'][store_code]',
					'class' => 'yith-wcgpf-store-code-product  yith-wcgpf-information',
					'value' => isset($product['store_code']) ? $product['store_code'] : ''
				)); ?>
			</div>
			<div class="yith-wcgpf-product-feed-information">
				<label for="yith-wcgpf-custom-label-4"><?php esc_html_e('Pickup method:', 'yith-google-product-feed-for-woocommerce');?></label>
				<?php echo yith_wcgpf_get_input(array(
					'id' => 'yith-wcgpf-pickup-method-product',
					'type' => 'text',
					'name' => 'yith-wcgpf-product-feed-configuration['.$variation->ID.'][pickup_method]',
					'class' => 'yith-wcgpf-pickup-method-product  yith-wcgpf-information',
					'value' => isset($product['pickup_method']) ? $product['pickup_method'] : ''
				)); ?>
			</div>
			<div class="yith-wcgpf-product-feed-information">
				<label for="yith-wcgpf-custom-label-4"><?php esc_html_e('Pickup sla:', 'yith-google-product-feed-for-woocommerce');?></label>
				<?php echo yith_wcgpf_get_input(array(
					'id' => 'yith-wcgpf-pickup-sla-product',
					'type' => 'text',
					'name' => 'yith-wcgpf-product-feed-configuration['.$variation->ID.'][pickup_sla]',
					'class' => 'yith-wcgpf-pickup-sla-product  yith-wcgpf-information',
					'value' => isset($product['pickup_sla']) ? $product['pickup_sla'] : ''
				)); ?>
			</div>
			<div class="yith-wcgpf-product-feed-information">
				<label for="yith-wcgpf-unit-pricing-measure"><?php esc_html_e('Unit pricing measure:', 'yith-google-product-feed-for-woocommerce');?></label>
				<?php echo yith_wcgpf_get_input(array(
					'id' => 'yith-wcgpf-unit-pricing-measure',
					'type' => 'text',
					'name' => 'yith-wcgpf-product-feed-configuration['.$variation->ID.'][unit_pricing_measure]',
					'class' => 'yith-wcgpf-unit-pricing-measure  yith-wcgpf-information',
					'value' => isset($product['unit_pricing_measure']) ? $product['unit_pricing_measure'] : ''
				)); ?>
			</div>
			<div class="yith-wcgpf-product-feed-information">
				<label for="yith-wcgpf-unit-pricing-base-measure"><?php esc_html_e('Unit pricing base measure:', 'yith-google-product-feed-for-woocommerce');?></label>
				<?php echo yith_wcgpf_get_input(array(
					'id' => 'yith-wcgpf-unit-pricing-base-measure',
					'type' => 'text',
					'name' => 'yith-wcgpf-product-feed-configuration['.$variation->ID.'][unit_pricing_base_measure]',
					'class' => 'yith-wcgpf-unit-pricing-base-measure  yith-wcgpf-information',
					'value' => isset($product['unit_pricing_base_measure']) ? $product['unit_pricing_base_measure'] : ''
				)); ?>
			</div>
        ...
        <div>
            ...
            <div class="yith-wcgpf-product-feed-information">
                ...
                <?php echo yith_wcgpf_get_input(array(
                    ...
                    'type' => 'text',
                    'name' => 'yith-wcgpf-shipping-feed-configuration['.$variation->ID.'][country]',
