...
class WC_Gateway_OPay_Now extends WC_Payment_Gateway {

	public function __construct() {
		$this->id = 'opay_now';
		$this->icon = OPGFW_WC_OPAY_URL . '/img/OPayNow.png';
		$this->has_fields = false;
		$this->method_title = 'OPayNOW';
		$this->method_description = 'OPay provide merchants with the tools and services needed to accept online payments. Supports consumers to pay with OPay Now.';
		...
		$this->nowcurrency = $this->get_option('nowcurrency');
    ...
    try {
			...
			$logger->add('opay_now', 'Order return result：' . $response);
