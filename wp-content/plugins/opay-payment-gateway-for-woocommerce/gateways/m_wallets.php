...
class WC_Gateway_OPay_WALLET extends WC_Payment_Gateway {

	public function __construct() {
		$this->id = 'm_wallets';
		$this->icon = OPGFW_WC_OPAY_URL . '/img/WALLET.png';
		$this->has_fields = false;
		$this->method_title = 'Mobile Wallet';
		$this->method_description = 'OPay offer easy access and fast payment methods make it easier for customers to pay. Only need to collect customer information and quickly complete the payment through scan QR code. It reduces the complex payment process and quickly meets the needs of merchants and customers.';
		...
		$this->walletcurrency = $this->get_option('walletcurrency');
    ...
    try {
			...
			$logger->add('m_wallets', 'Order return result：' . $response);
