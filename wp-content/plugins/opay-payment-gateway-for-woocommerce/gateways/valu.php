...
class WC_Gateway_OPay_VALU extends WC_Payment_Gateway {

	public function __construct() {
		$this->id = 'valu';
		$this->icon = OPGFW_WC_OPAY_URL . '/img/VALU.png';
		$this->has_fields = false;
		$this->method_title = 'ValU';
		$this->method_description = 'OPay provide consumers with convenient payment methods, and convenient installment payment allows customer to reduce the payment burden,empower with the financial solution you need that is within your capacity. The fast approval process makes the payment process smoother.';
		...
		$this->valucurrency = $this->get_option('valucurrency');
    ...
    try {
			...
			$logger->add('valu', 'Order return result：' . $response);
