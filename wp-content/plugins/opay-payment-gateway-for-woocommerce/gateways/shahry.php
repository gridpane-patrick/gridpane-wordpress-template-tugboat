...
class WC_Gateway_OPay_SHAHRY extends WC_Payment_Gateway {

	public function __construct() {
		$this->id = 'shahry';
		$this->icon = OPGFW_WC_OPAY_URL . '/img/SHAHRY.png';
		$this->has_fields = false;
		$this->method_title = 'Shahry';
		$this->method_description = 'OPay provide merchants with the tools and services needed to accept online payments. Supports consumers to pay with Shahry.';
		...
		$this->shahrycurrency = $this->get_option('shahrycurrency');
    ...
    try {
			...
			$logger->add('shahry', 'Order return result：' . $response);
