		...
		public function sales_booster_page_init_scripts() {
			...
			$this->icons = array(
				'simple' => array(
                    ...
                    'et_icon-tick'            => esc_html__( 'Tick', 'xstore-core' ),
		...
		public function sales_booster_page() {
            ...
            <div class="et-tabs-filters-wrapper">
                ...
                <ul class="et-filters et-tabs-filters">
                    ...
                    <li class="<?php echo 'account' == $active_tab ? 'active' : ''; ?>"
                        data-tab="account"><?php echo esc_html__( 'Account Page', 'xstore-core' ); ?></li>
...
<!--                            -->
            ...
            <div class="et-tabs-content<?php if ( $tab_content == $active_tab ) {
                ...
                <div class="tab-preview">
                    ...
                    <img src="<?php echo $this->dir_url . '/images/' . $tab_content . $postfix . '.jpg'; ?>" alt="">
                    <div>
                        <h4><?php echo esc_html__( 'Enable Advanced reviews', 'xstore-core' ) . ':'; ?></h4>
                        <p><?php echo esc_html__( 'Enable this option to have new-fashion style for reviews on single product pages.', 'xstore-core' ); ?></p>
                        <label class="et-panel-option-switcher<?php if ( $settings_enabled ) { ?> switched<?php } ?>"
                               for="<?php echo esc_attr( $this->global_admin_class->settings_name ) . '_' . $tab_content . $postfix; ?>">
                            <input type="checkbox"
                                   id="<?php echo esc_attr( $this->global_admin_class->settings_name ) . '_' . $tab_content . $postfix; ?>"
...
//                                            'image/svg+xml',
            ...
            <div class="et-tabs-content<?php if ( $tab_content == $active_tab ) {
                ...
                <div class="tab-preview">
                    <img src="<?php echo $this->dir_url . '/images/' . $tab_content . $postfix . '.jpg'; ?>" alt="">
                    <div>
                        <h4><?php echo esc_html__( 'Enable loyalty program info on Account page', 'xstore-core' ) . ':'; ?></h4>
                        <p><?php echo esc_html__( 'Register your account benefits items shown for your customers on My account page and account off-canvas area. This can motivate them to shopping again on your store.', 'xstore-core' ); ?></p>
                        <label class="et-panel-option-switcher<?php if ( $settings_enabled ) { ?> switched<?php } ?>"
                               for="<?php echo esc_attr( $this->global_admin_class->settings_name ) . '_' . $tab_content . $postfix; ?>">
                            <input type="checkbox"
                                   id="<?php echo esc_attr( $this->global_admin_class->settings_name ) . '_' . $tab_content . $postfix; ?>"
                ...
                <div class="tab-preview">
                    ...
                    <img src="<?php echo $this->dir_url . '/images/' . $tab_content . $postfix . '.jpg'; ?>" alt="">
                    <div>
                        <h4><?php echo esc_html__( 'Enable login/register tabs on Account page', 'xstore-core' ) . ':'; ?></h4>
                        <p><?php echo esc_html__( 'Make your basic login/register forms with switcher so it will be more iteractive for customers.', 'xstore-core' ); ?></p>
                        <label class="et-panel-option-switcher<?php if ( $settings_enabled ) { ?> switched<?php } ?>"
                               for="<?php echo esc_attr( $this->global_admin_class->settings_name ) . '_' . $tab_content . $postfix; ?>">
                            <input type="checkbox"
                                   id="<?php echo esc_attr( $this->global_admin_class->settings_name ) . '_' . $tab_content . $postfix; ?>"
