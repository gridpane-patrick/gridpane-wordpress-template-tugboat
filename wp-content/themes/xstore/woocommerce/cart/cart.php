                            ...
                            <td class="product-details">
                                <div class="cart-item-details">
                                    ...
                                    if ( ! $_product->is_visible() || ! $product_permalink  ){
                                         ...
                                         */
                                        echo wp_kses_post( apply_filters( 'woocommerce_cart_item_name', sprintf( '<a href="%s" class="product-title">%s</a>', esc_url( $product_permalink ) , $product_name ), $cart_item, $cart_item_key ) );
                                    }
